...
main = do
  ...
  let tsString =
        [((Pos 1 1,Pos 1 7), "ITmodule"),
        ((Pos 1 8,Pos 1 15), "ITconid"),
        ((Pos 2 5,Pos 2 6), "IToparen"),
        ((Pos 2 7,Pos 2 15), "ITvarid"),
        ((Pos 3 5,Pos 3 6), "ITcparen"),
        ((Pos 3 7,Pos 3 12), "ITwhere"),
        ((Pos 5 1,Pos 5 1), "ITvocurly"),
        ((Pos 5 1,Pos 5 9), "ITvarid"),
        ((Pos 5 10,Pos 5 12), "ITdcolon NormalSyntax"),
        ((Pos 5 13,Pos 5 15), "ITconid"),
        ((Pos 5 16,Pos 5 17), "IToparen"),
        ((Pos 5 17,Pos 5 18), "ITcparen"),
        ((Pos 6 1,Pos 6 1), "ITsemi"),
        ((Pos 6 1,Pos 6 9), "ITvarid"),
        ((Pos 6 10,Pos 6 11), "ITequal"),
        ((Pos 6 12,Pos 6 20), "ITvarid"),
        ((Pos 6 21,Pos 6 31), "ITstring"),
        ((Pos 8 1,Pos 10 5), "ITblockComment"),
        ((Pos 11 1,Pos 11 1), "ITsemi"),
        ((Pos 11 1,Pos 11 6), "ITvarid"),
        ((Pos 11 7,Pos 11 8), "ITequal"),
        ((Pos 11 9,Pos 13 8), "ITstring"),
        ((Pos 13 11,Pos 13 35), "ITlineComment"),
        ((Pos 14 1,Pos 14 1), "ITsemi")]
